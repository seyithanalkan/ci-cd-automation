...
aws elasticbeanstalk create-application-version --application-name "react-web-aplication" --version-label 1 --source-bundle S3Bucket=seyithan-react,S3Key=Dockerrun.aws.json
